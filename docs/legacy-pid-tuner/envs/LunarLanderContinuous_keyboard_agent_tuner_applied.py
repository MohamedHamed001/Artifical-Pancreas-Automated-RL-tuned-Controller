...
# Ensure the legacy LunarLander tuner package root is importable when this
# script is run directly from this folder.
...
def rollout(env):
    ...
    # Legacy comment: previously loaded from a hardcoded /home/diominor path.
    # Replace with a local relative path if you wish to resume from a checkpoint.
